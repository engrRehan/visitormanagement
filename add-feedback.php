                ...
                <div class="col-md-12 col-lg-8 main-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            ?>
                            <h3>Add Feedback from <b><?php echo $rows['name'];?></b></h3><br>
                            <form id="contact-form" name="contact-form" action="includes/main.php" method="POST" enctype="multipart/form-data">
                            <table class="full-width">
                                <tr>
                                    <td width="20%"><label for="name" class="">Checkout Time</label></td>
                                    <td width="70%">
                                        <div class="col-md-6 top-ten ">
                                            <div class="md-form">
                                                <input type="hidden"  name="action" class="form-control" value="add-feedback">
                                ...
                                <tr>
                                    ...
                                    <td width="70%">
                                        <div class="col-md-6 top-ten">
                                            <div class="md-form">
                                                <textarea rows="10" cols="50" id="feedback" name="feedback" class="form-control required"><?php echo $rows['feedback'];?></textarea>
                                            </div>
                                        </div>
                                    </td>
                                </tr>

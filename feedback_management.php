                                ...
                                if(isset($rows) && !empty($rows)){
                                    foreach($rows as $key => $row){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <!--<a href="edit-visitor.php?id=<?php echo $row['id'];?>" data-placement="top" data-toggle="tooltip" title="Edit"><button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="glyphicon glyphicon-pencil"></span></button></a>-->
